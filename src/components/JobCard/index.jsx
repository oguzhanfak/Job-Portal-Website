...
function JobCard(props) {
    // const skills= ["Nodejs","JavaScript","React","Sass"]
    const date1 = dayjs(Date.now())
    const diffInDays = date1.diff(props.postedOn,'day')
  return (
    <div className='mx-40 mb-4'>
        <div className='flex justify-between items-center px-6 py-4 bg-zinc-200 rounded-md border border-black shadow-lg hover:border-gray-500 hover:translate-y-1 hover:scale-103'>
